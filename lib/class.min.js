...
return g;};Class._convert=function(b,c){var a=function(e,g){var f=function(){return e.apply(this,g||[]);};f.prototype=e.prototype;return new f();};var d={init:function(){var e=Array.prototype.slice.call(arguments);
this[c]=a(b,e);}};Object.keys(b.prototype).forEach(function(e){if(c=="init"){return;}d[e]=function(){return this[c][e].apply(this[c],arguments);};});return this._extend(d);
