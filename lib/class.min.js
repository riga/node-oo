...
if(!classInitializing&&this.init){return this.init.apply(this,arguments);}return this;};var j=this.prototype;h._superClass=this;this._subClasses=this._subClasses||[];
this._subClasses.push(h);classInitializing=true;var g=new this();classInitializing=false;h._extends=function(k){if(k==this._superClass){return true;}else{if(this._superClass==Class){return false;
